...
const cardData: BentoCardProps[] = [
  {
    ...
    description: "Everything you need to know before applying for your first UAE home loan.",
    label: "Guides",
  },
  {
    color: "#060010",
    title: "Self-Employed Mortgages",
    description: "Proven strategies to get approved with variable income.",
    label: "Tips",
  },
  {
    color: "#060010",
    title: "Fixed vs Variable Rates",
    description: "Compare pros and cons to make an informed decision for your mortgage.",
    label: "Rates",
  },
  {
    color: "#060010",
    title: "Dubai Property Market 2025",
    description: "Latest trends and what to expect when buying in the UAE.",
    label: "Market",
  },
  {
    color: "#060010",
    title: "Down Payment Strategies",
    description: "How to save for your 20% down payment faster.",
    label: "Savings",
  },
  {
    color: "#060010",
    title: "Refinancing Your Loan",
    description: "When and how to refinance for better rates.",
    label: "Refinance",
  },
];
...
const BentoCardGrid: React.FC<{
  ...
  gridRef?: React.RefObject<HTMLDivElement | null>;
  gridClassName?: string;
}> = ({ children, gridRef, gridClassName }) => (
  <div
    className={`bento-section grid gap-2 p-3 max-w-[54rem] select-none relative ${gridClassName ?? ""}`}
