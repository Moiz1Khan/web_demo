...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full rounded-2xl border border-border bg-card shadow-xl ${stepCircleContainerClassName}`}
      >
        ...
        <StepContentWrapper
          ...
          currentStep={currentStep}
          direction={direction}
          className={`space-y-4 px-6 pb-6 ${contentClassName}`}
        >
          {stepsArray[currentStep - 1]}
        </StepContentWrapper>

        {!isCompleted && (
          <div className={`border-t border-border px-6 pb-6 pt-4 ${footerClassName}`}>
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators = false }: StepIndicatorProps) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "var(--border)", color: "var(--muted-foreground)" },
